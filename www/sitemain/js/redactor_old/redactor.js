...
(function($)
{
    ...
    $.Redactor.opts = {
        ...
        imageGetJson: true, // url (ex. /folder/images.json ) or false
        ...
        //buttons: ['image', 'video', 'link'], // 'underline', 'alignleft', 'aligncenter', 'alignright', 'justify'
...
//            olegfox
            return this.$frame.contents().children().find("body").html();
        },
...
//olegfox
            this.$source.val(this.$editor.html());
