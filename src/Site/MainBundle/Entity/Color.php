 ...
 * @ORM\Entity(repositoryClass="Site\MainBundle\Entity\Repository\ColorRepository")
 */
class Color
{
     ...
     * @ORM\JoinColumn(name="id_color_group",  referencedColumnName="id")
     */
    private $colorGroup;
     ...
     * Set colorGroup
     *
     * @param \Site\MainBundle\Entity\ColorGroup $colorGroup
     * @return Color
     */
    public function setColorGroup(\Site\MainBundle\Entity\ColorGroup $colorGroup = null)
    {
     ...
     * Get colorGroup
     *
     * @return \Site\MainBundle\Entity\ColorGroup 
     */
